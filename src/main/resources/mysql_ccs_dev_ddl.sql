...
CREATE TABLE COMPLIMENTS (
    ...
    C_USED BOOLEAN DEFAULT FALSE NOT NULL
);
...
INSERT INTO COMPLIMENTS (C_SENDER, C_RECEIVER, C_MESSAGE, C_USED) VALUES ('LCAHILL', 'DCAHILL', 'KEEP UP THE GREAT WORK AT THE NYISO - YOU''RE DOING AWESOME!', 1);
...
SELECT * FROM COMPLIMENTS WHERE C_RECEIVER = 'DCAHILL' AND `C_USED` = 0; 

SELECT * FROM USERS WHERE U_USERNAME = 'DCAHILL';